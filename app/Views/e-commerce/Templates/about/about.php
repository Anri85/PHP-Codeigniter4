        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="contact-info">
                    <h2>Our Office</h2>
                    <h3><i class="fa fa-map-marker"></i>Jl. Arkeologi No. 43 Cileunyi Kab. Bandung</h3>
                    <h3><i class="fa fa-envelope"></i>aryasubagja20@gmail.com</h3>
                    <h3><i class="fa fa-phone"></i>+628-821-848-5986</h3>
                    <!-- <div class="social">
            ...
            <div class="col-lg-4">
                <div class="contact-info">
                    ...
                    <h6 class="text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Hic saepe qui nobis vel fugiat, aliquid provident totam illo optio quaerat necessitatibus eum quia velit ipsa inventore deserunt enim, sapiente nesciunt.</h6>
                </div>
            </div>
            <div class="col-lg-4">
